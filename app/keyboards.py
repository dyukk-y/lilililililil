...
def first_comment_keyboard() -> InlineKeyboardMarkup:
    """Клавиатура под первым (приветственным) комментарием бота в чате
    комментариев основного канала. Тексты кнопок и ссылки — динамические
    настройки (FIRST_COMMENT_*), их меняют супер-админы через админ-панель,
    без правки кода. Расположение: главная кнопка сверху на всю ширину,
    две второстепенные — в один ряд под ней."""
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(
                text=get_setting("FIRST_COMMENT_BTN_OFFER_TEXT"),
                url=get_setting("FIRST_COMMENT_BTN_OFFER_URL"),
            )
        ],
        [
            InlineKeyboardButton(
                text=get_setting("FIRST_COMMENT_BTN_STARS_TEXT"),
                url=get_setting("FIRST_COMMENT_BTN_STARS_URL"),
            ),
            InlineKeyboardButton(
                text=get_setting("FIRST_COMMENT_BTN_VPN_TEXT"),
                url=get_setting("FIRST_COMMENT_BTN_VPN_URL"),
            ),
        ],
    ])
